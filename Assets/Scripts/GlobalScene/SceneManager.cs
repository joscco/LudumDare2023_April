...
public class SceneManager : MonoBehaviour
{
    ...
    public SpriteRenderer pizzaSchieber;
        ...
        private void Start()
        {
            ...
            UnityEngine.SceneManagement.SceneManager.LoadScene("FocusScene", LoadSceneMode.Additive);
        ...
        private IEnumerator FadeInStartAndFadeOut(String levelName, int level)
        {
            ...
            AsyncOperation asyncLoad = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(levelName, LoadSceneMode.Additive);
            ...
            {
                UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync(_currentSceneName);
            }
